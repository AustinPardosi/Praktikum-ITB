...
public class Pembunuh implements Kelas {
    ...
    public void serang(Karakter self, Karakter target) {
        ...
        System.out.print(", sang pembunuh, menyerang ");
    ...
    public void gunakanKemampuan(Karakter self, Karakter target) {
        if(target.isHidup()) {
            if (target.getHealth() >= 20) {
                self.addHealth(20);
                System.out.print(self.getName());
                System.out.print(" menyerap health ");
                System.out.print(target.getName());
                System.out.print(" sebesar ");
                System.out.println(20);
                target.terimaSerangan(20);
            } else {
                int lostHealth = target.getHealth();
                self.addHealth(lostHealth);
                System.out.print(self.getName());
                System.out.print(" menyerap health ");
                System.out.print(target.getName());
                System.out.print(" sebesar ");
                System.out.println(lostHealth);
                target.terimaSerangan(lostHealth);
            }
        } else {
            System.out.print(target.getName());
            System.out.println(" sudah mati, tidak bisa diserap healthnya");
        }
    }
    ...
    public void gunakanUltimate(Karakter self, Karakter target) {
        if (!target.isHidup()) {
            ...
            self.addMana(20);
            System.out.print(self.getName());
            System.out.print(" menyalin wujud ");
            System.out.println(target.getName());

            System.out.print(target.getName());
            System.out.println(" berhasil disalin wujudnya");
            System.out.print(self.getName());
            System.out.println(" memperoleh 40 health dan 20 mana");
        } else {
            System.out.print(target.getName());
            System.out.println(" belum mati, tidak bisa disalin wujudnya");
        }
    }
}
