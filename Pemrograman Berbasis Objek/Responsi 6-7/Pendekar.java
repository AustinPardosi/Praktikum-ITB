...
public class Pendekar implements Kelas {
    ...
    public void serang(Karakter self, Karakter target) {
        ...
        System.out.print(", sang pendekar, menyerang ");
    ...
    public void gunakanKemampuan(Karakter self, Karakter target) {
        if (target.isHidup()) {
            System.out.print(self.getName());
            System.out.print(" memukul mundur ");
            System.out.print(target.getName());
            System.out.print(" dengan ");
            System.out.println(this.perisai);
            target.terimaSerangan(40);
        } else {
            System.out.print(target.getName());
            System.out.println(" sudah mati, tidak bisa dipukul mundur");
        }
    }
    ...
    public void gunakanUltimate(Karakter self, Karakter target) {
        if(target.isHidup()) {
            ...
            self.addMana(20);
            System.out.print(self.getName());
            System.out.println(" menyerukan nada peperangan");
            System.out.print(self.getName());
            System.out.println(" mendapatkan 30 health dan 20 mana");
            System.out.print(self.getName());
            System.out.print(" menyerang ");
            System.out.print(target.getName());
            System.out.print(" dengan ");
            System.out.print(this.senjata);
